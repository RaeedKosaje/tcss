...
class Edithardwarekey extends StatelessWidget {
  final int deviceid;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('edite hardware key'),
      ),
      drawer: NavDrawer(),
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            ElevatedButton(
              ...
              child: const Text('edite Hardware key'),
            ),
          ],
        ),
      ),
  ...
  Future<bool> createDevice({
    ...
    final Uri url = Uri.parse('$urlbase/editHardwarekey/$deviceid');
    ...
    if (response.statusCode == 200) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('edite Hardware key successfully')),
      );
      return true;
    } else {
      // فشل العملية
